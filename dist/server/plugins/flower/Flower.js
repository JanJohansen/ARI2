...
var Graph = (function () {
    ...
    // Component handling
    Graph.prototype.getNextFreeComponentId = function (component) {
        var i = 1;
        var id = component.id;
    ...
    Graph.prototype.getComponent = function (componentName) {
        return this.components[componentName];
    };
    Graph.prototype.renameComponent = function () {
    };
    Graph.prototype.removeComponent = function () {
    };
    // Connections handling
    Graph.prototype.connect = function (sCompName, sOutputName, dCompName, dInputName) {
    ...
    Graph.prototype.disconnect = function (sCompName, sOutputName, dCompName, dInputName) {
        var sc = this.getComponent(sCompName);
        var dc = this.getComponent(dCompName);
        if (sc && dc) {
...
exports.NOP = NOP;
//# sourceMappingURL=C:/Users/Jan/Desktop/ARI2_Test/dist/server/plugins/flower/Flower.js.map